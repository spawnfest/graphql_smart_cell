// KinoDB v0.2.0 | Apache-2.0 License | https://github.com/livebook-dev/kino_db
...
export function init(ctx, info) {
  ...
  const app = Vue.createApp({
    ...
    <div class="app">
      ...
      <form @change="handleFieldChange">
        <div class="container">
          ...
          <GraphQLForm v-bind:fields="fields" v-if="isDefaultServer" />
        </div>
      </form>
    </div>
    `,
    ...
    computed: {
      isDefaultServer() {
        return ["graphql"].includes(this.fields.type);
      },
    },
