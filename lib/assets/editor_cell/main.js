...
function graphiql_init(ctx, payload, root) {
  ...
  //     <div class="graphiql-sessions">
  //       <div role="tabpanel" id="graphiql-session" class="graphiql-session" aria-labelledby="graphiql-session-tab-0">
  //         <div style="display: flex; flex-direction: row; flex: 1 1 0%;">
  //           <div class="graphiql-editors full-height">
  //             <div style="display: flex; flex-direction: column; flex: 3 1 0%;">
  //               <section class="graphiql-query-editor" aria-label="Query Editor">
  //                 <div class="graphiql-query-editor-wrapper">
  //                   <div class="graphiql-editor">
